type Props = { name: "instagram" | "facebook" | "youtube" | "whatsapp"; className?: string };

/** Ícones de redes sociais em SVG (sem dependência externa). */
export function SocialIcon({ name, className = "size-4" }: Props) {
